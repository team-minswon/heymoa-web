...
**아직 맞추지 못한 것.** 390에서 「기능 소개」 카드가 아트보드보다 합계 152px 큽니다 —
카드 안 목업을 모바일 아트보드는 한 단 작게 다시 그렸는데(줄 사이가 구분선 대신 9px 간격,
글자 1~1.5px 작음) 코드는 데스크톱 것을 그대로 씁니다. 「작동 방식」 +44, 「사용 흐름」 −50도
같은 줄기입니다.

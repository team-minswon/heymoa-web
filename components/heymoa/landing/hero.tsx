 ...
 *
 * **위 여백이 시안(96)보다 큰 이유.** 이 앱의 상단바는 `fixed top-4`로 떠 있는 알약이라
 * 시안의 정적 바와 자리를 다르게 먹는다. 시안 값을 그대로 주면 킥커가 알약 아래로 들어간다 —
 * 알약 높이(약 60)만큼 더 줘서 제목이 시안과 같은 눈높이에 오게 한다.
 */
export function Hero() {
  return (
    <section
      className={`${SECTION_X} flex flex-col items-center pt-[104px] lg:pt-[136px]`}
    >
      <div className={`${CONTAINER} flex flex-col items-center`}>
        ...
        <h1 className="m-0 mt-[11px] max-w-[840px] text-balance break-keep text-center text-[38px] font-extrabold leading-[1.18] tracking-[-1.3px] text-[var(--lp-ink)] lg:mt-[14px] lg:text-[76px] lg:leading-[1.14] lg:tracking-[-2.4px]">
          회의 시간을 새지 않게
        </h1>

        <div className="mt-5 flex max-w-[700px] flex-col items-center gap-1.5 lg:mt-[26px]">
        ...
        <div className="mt-[26px] flex w-full max-w-[350px] flex-col gap-2.5 lg:mt-[34px] lg:w-auto lg:max-w-none lg:flex-row lg:items-center lg:gap-3">
          <LandingCta

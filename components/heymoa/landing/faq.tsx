...
const QA: Array<{ q: string; a: string }> = [
  {
    ...
    a: "스크립트와 요약에서 멈추지 않습니다. 결정과 액션 아이템에는 그 말이 나온 스크립트 줄이 근거로 붙어 눌러서 되짚을 수 있고, 회의는 프로젝트 단위로 묶여 쌓입니다. 지난 회의를 되짚는 것은 에이전트에게 물어보는 방식입니다.",
  },
  {
    q: "회의 중에 흐름을 끊지 않고 물어볼 수 있나요?",
    a: "네. 회의가 도는 동안에도 오른쪽 레일에서 에이전트에게 바로 물어볼 수 있고, 지금까지의 스크립트와 지난 회의를 함께 보고 답합니다.",
  },
  {

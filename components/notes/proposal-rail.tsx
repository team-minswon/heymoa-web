...
import { ProposalCard } from "@/components/notes/proposal-card";
...
const FILTERS: Array<{
  value: Filter;
  label: string;
  kinds?: ReadonlySet<ProposalHead["kind"]>;
}> = [
  { value: "ALL", label: "전체" },
 ...
 */
const GROUP_ORDER: ReadonlyArray<ProposalHead["kind"]> = [
  "DECISION",
  "ACTION_ITEM",
  "AGENDA",
  "ISSUE",
...
/**
 * 묶음이 접히고 펼쳐지는 움직임. `proposal-card.tsx` · `note-summary.tsx` 와 같은
...
function matches(card: ProposalHead, filter: Filter) {

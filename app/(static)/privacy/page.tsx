...
const sections = [
  {
    ...
    body: [
      ...
      "회의 기록 기능을 사용하는 동안 마이크에서 입력된 음성 데이터와 그 음성으로 생성된 실시간 전사, 확정 문장, 회의록 제목 및 회의 메타데이터를 처리합니다.",
  ...
  },
  {
    title: "2. 처리 목적",
    body: [
      "회원 식별과 로그인 유지, 워크스페이스 운영, 실시간 회의 전사, 회의록 저장과 조회, 서비스 보안 및 부정 이용 방지를 위해 정보를 사용합니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "현재 실시간 음성은 별도 녹음 파일로 저장하지 않는 것을 원칙으로 하며, 확정된 전사 문장은 회의록 제공을 위해 저장됩니다.",
  ...
  },
  {
    title: "4. 보관 및 파기",
    body: [
      "개인정보와 회의 데이터는 서비스 제공에 필요한 기간 동안 보관하며, 이용 목적이 달성되거나 계정·회의록 삭제 요청이 처리되면 관련 법령상 보존 의무가 없는 범위에서 파기합니다.",

...
export const getSendAgentChatMessageMutationKey = () =>
  ["sendAgentChatMessage"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    SendAgentChatMessageMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof apiFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getSendAgentChatMessageMutationKey();
...
export type SendAgentChatMessageMutationError =
  | AppErrorResponse
  | UnauthorizedResponse;
export type SendAgentChatMessageMutationVariables = {
  chatId: string;
  data?: SendAgentChatMessageRequest;
};
...
export const getCreateAgentChatMutationKey = () => ["createAgentChat"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    CreateAgentChatMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof apiFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getCreateAgentChatMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type CreateAgentChatMutationError =
  | UnauthorizedResponse
  | AppErrorResponse;
export type CreateAgentChatMutationVariables = {
  workspaceId: string;
  data?: CreateAgentChatRequest;
};
...
export const getResolveToolApprovalMutationKey = () =>
  ["resolveToolApproval"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    ResolveToolApprovalMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof apiFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getResolveToolApprovalMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type ResolveToolApprovalMutationError =
  | AppErrorResponse
  | UnauthorizedResponse;
export type ResolveToolApprovalMutationVariables = {
  chatId: string;
  approvalId: string;
...
export const getCancelAgentChatTurnMutationKey = () =>
  ["cancelAgentChatTurn"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    CancelAgentChatTurnMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof apiFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getCancelAgentChatTurnMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type CancelAgentChatTurnMutationError =
  | UnauthorizedResponse
  | AppErrorResponse;
export type CancelAgentChatTurnMutationVariables = {
  chatId: string;
  turnId: string;
};

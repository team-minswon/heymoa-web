...
export const getDeleteWorkspaceGuestMutationKey = () =>
  ["deleteWorkspaceGuest"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    DeleteWorkspaceGuestMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof apiFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getDeleteWorkspaceGuestMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type DeleteWorkspaceGuestMutationError =
  | UnauthorizedResponse
  | AppErrorResponse;
export type DeleteWorkspaceGuestMutationVariables = {
  workspaceId: string;
  guestId: string;
};
...
export const getLinkWorkspaceGuestMutationKey = () =>
  ["linkWorkspaceGuest"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    LinkWorkspaceGuestMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof apiFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getLinkWorkspaceGuestMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type LinkWorkspaceGuestMutationError =
  | UnauthorizedResponse
  | AppErrorResponse;
export type LinkWorkspaceGuestMutationVariables = {
  workspaceId: string;
  guestId: string;
...
export const getPreviewWorkspaceGuestLinkMutationKey = () =>
  ["previewWorkspaceGuestLink"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    PreviewWorkspaceGuestLinkMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof apiFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getPreviewWorkspaceGuestLinkMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
...
export type PreviewWorkspaceGuestLinkMutationError =
  | UnauthorizedResponse
  | AppErrorResponse;
export type PreviewWorkspaceGuestLinkMutationVariables = {
  workspaceId: string;
  guestId: string;
  data?: LinkWorkspaceGuestRequest;
};

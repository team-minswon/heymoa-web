...
| plan 파일명 | `YYYY-MM-DD-APP-N-이슈제목.md` | `2026-07-26-APP-205-인증-만료-시-token-refresh-무한-루프-세션-게이트-전역-재시도-정책.md` |
...
| ② 설계 확정 (docs repo의 spec을 읽고 착수안을 정한 뒤) | 무엇을 정했고 무엇을 일부러 안 했나. spec 경로를 링크합니다 |
